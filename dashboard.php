                        ...
                        <div class="col-auto genralInfoCOl">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title infoStats" id="totalDepartment">3</h5>
                                        <h5 class="card-title infoTitle"><i class="fa fa-building mr-2"
                                                aria-hidden="true"></i>
                                            Department</h5>
                                    </div>
                                </div>
                            ...
                            <div class="col-auto genralInfoCOl">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title infoTitle"><i class="fa fa-list-alt mr-2" aria-hidden="true"></i> Categories</h5>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function getChartData() {
            ...
            XRH.onload = function () {
                ...
                document.getElementById("totalDepartment").innerHTML = obj.totalDepartment;
