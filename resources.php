...
<body>
    <div class="wrapper">
        ...
        <div class="main">
                ...
                <div class="modal-dialog modal-fullscreen">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <script>
                                ...
                                function onSelectChange() {
                                    ...
                                    for (var i = 0; i < resNum; i++) {
                                        ...
                                        resConditionData +='<div class="col-auto me-1 mb-1"><p class="addResourceRowTitle">Resource Condition: </p><select name="resCondition" id="resourceConditionModel'+ i +'" class="form-control"><option value="Working">Working</option><option value="Repairable(With Worranty)">Repairable(With Worranty)</option><option value="Repairable(Without Worranty)">Repairable(Without Worranty)</option><option value="Under Reparing">Under Reparing</option><option value="Demaged">Demaged</option></select></div>';                                       
                                    }
                                    ...
                                    document.getElementById("addResourceConditionRow").innerHTML = resConditionData;
                                }
                            </script>
                            ...
                            <div class="row " id="addResourceConditionRow">
                            </div>
            ...
            <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-fullscreen">
                    <div class="modal-content p-3" style="  height: auto;">
                        ...
                        <div class="col-auto me-1 mb-1">
                            <p class="addResourceRowTitle">Resource Condition: </p>
                            <select name="resCondition" id="resourceConditionUpdateModel" class="form-control">
                                <option value="Working">Working</option>
                                <option value="Repairable(With Worranty)">Repairable(With Worranty)</option>
                                <option value="Repairable(Without Worranty)">Repairable(Without Worranty)</option>
                                <option value="Under Reparing">Under Reparing</option>
    ...
    <script>
        ...
        function addResource() {
            ...
            var resConditionArray = new Array();
            var resConditionElement = document.getElementsByName("resCondition");
            ...
            for (var i = 0; i < resNameElement.length; i++) {
                if (resNameElement[i].value == "") {
                    ...
                    empty = true;
                    inputID = "resourceCompanyModal" + i;resourceCompanyModal
                    break;
                }
                else {
                    ...
                    resConditionArray.push(resConditionElement[i].value);
                }
            }
            ...
            if (empty) {
                ...
                console.log(resConditionArray);

                var data = "resourceNum=" + resourceNum + "&resourceMACAddress=" + resourceMACAddArray + "&resourceCompany=" + resourceCompanyArray +"&resCondition="+ resConditionArray+ "&resourceName=" + resourceNameArray +"&rescondition=" + resConditionArray + "&resourceDesc=" + resourceDescArray + "&resourceCategory=" + resourceCategory + "&resourceSection=" + resourceSection + "";
                console.log(data);
        ...
        function fetchtotalrows() {
            ...
            XRH.onload = function () {
                ...
                totalnumber="Total Resources: "+obj;
        ...
        function updateResource() {
            ...
            var updatedCondition =document.getElementById("resourceConditionUpdateModel").value;

            if (updatedName == "" || updatedCompany == "" || updatedDesc == "" || updatedMAC == "" || updatedMAC.length != 17) {
            }
            else {
                var data = "resourceID=" + resID + "&resourceName=" + updatedName + "&resourceMAC=" + updatedMAC + "&resourceCompany=" + updatedCompany + "&resourceDesc=" + updatedDesc + "&resourceCondition=" + updatedCondition + "";
                console.log(data);
                var XRH = new XMLHttpRequest();
